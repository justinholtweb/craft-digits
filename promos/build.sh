...
# Output: promos/out/digits-promo-N.jpg at 1920x1080 (rendered at 2x, downsampled).
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/digits-promo-$n.png" \
  ...
  sips --resampleWidth 1920 -s format jpeg -s formatOptions 90 \
    "out/digits-promo-$n.png" --out "out/digits-promo-$n.jpg" >/dev/null
  rm "out/digits-promo-$n.png"
  echo "  built out/digits-promo-$n.jpg"
done
